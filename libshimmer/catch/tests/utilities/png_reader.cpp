...
void CHECK_8x9x8_RGB ( const image& png ) {
...
void CHECK_8x9x8_RGBA ( const image& png ) {
    unsigned int expected_width     = 8;
    unsigned int expected_height    = 9;
...
TEST_CASE ( "Read a 8x9x8 RGB png image",
            "[png_reader]" )
{
    CHECK_8x9x8_RGB ( png_reader::read ( "data/images/8x9x8_rgb.png" ) );
}

TEST_CASE ( "Read a 8x9x8 RGBA png image",
            "[png_reader]" )
{
    CHECK_8x9x8_RGBA ( png_reader::read ( "data/images/8x9x8_rgba.png" ) );
}
    ...
    "[png_reader]" )
{
    CHECK_8x9x8_RGB ( png_reader::read (
                          "data/images/8x9x8_rgb_adam7.png" ) );
}
    ...
    "[png_reader]" )
{
    CHECK_8x9x8_RGBA ( png_reader::read (
                           "data/images/8x9x8_rgba_adam7.png" ) );
}
...
TEST_CASE (
    ...
    "[png_reader]" )
{
    REQUIRE_THROWS ( png_reader::read ( "data/file_reader/simple.txt" ) );
}
...
TEST_CASE (
    ...
    "[png_reader]" )
{
    REQUIRE_THROWS ( png_reader::read ( "data/images/8x9x8_rgb.jpeg" ) );
}
...
TEST_CASE (
    ...
    "[png_reader]" )
{
    REQUIRE_THROWS ( png_reader::read ( "data/images/8x9x8_rgba.jpeg" ) );
}
    ...
    "[png_reader]" )
{
    ...
    image img_a ( reader.read_header(), nullptr );
    ...
    "[png_reader]" )
{
    ...
    image img_a ( reader.read_header(), nullptr );
    image img_b ( reader.read_header(), nullptr );
